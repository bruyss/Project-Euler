...
# the reverse and add process is called a Lychrel number. Due to the theoreti-
# -cal nature of these numbers, and for the purpose of this problem, we shall
# assume that a number is Lychrel until proven otherwise. In addition you are
# given that for every number below ten-thousand, it will either (i) become a
